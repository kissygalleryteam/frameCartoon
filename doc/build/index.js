 ...
 * @module frameCartoon
 **/
KISSY.add('kg/frameCartoon/2.0.0/index',function (S, Node) {
    var EMPTY = '';
    var $ = Node.one;
    ...
    function FrameCartoon(comConfig) {
        ...
        self.speed = comConfig.speed || 2.0.0;
        self.frameWidth = comConfig.frameWidth || 2.0.0;
